	...
	var app = new Vue({
	  ...
	  data: {
	    ...
	    step_4: {
	    	canvas: null,
	    	imgs: {
	    		bubble: imageBase + 'step_4/bubble.png',
	    		fish_tail: imageBase + 'step_4/fish_tail.png',
	    		headdress: imageBase + 'step_4/headdress.png',
	    		bubble_big: imageBase + 'step_4/bubble_big.png',
	    		fish_tail_big: imageBase + 'step_4/fish_tail_big.png',
	    	...
	    	decorations: [
	    		{
	    			img: imageBase + 'step_4/bubble_big.png',
	    			position: {
	    				x: -150,
	    				y: -150
	    			},
	    		...
	    		{
		    		img: imageBase + 'step_4/fish_tail_big.png',
		    		position: {
		    			x: -350,
		    			y: -10
		    		},
	    		...
	    		{
		    		img: imageBase + 'step_4/headdress_big.png',
		    		position: {
		    			x: -50,
		    			y: -50
		    		},
